...
export function Employees({
  ...
  const filteredEmployees = React.useMemo(() => {
    return employees.filter((employee) => {
      ...
      const matchesRole =
        selectedRole === 'All' ||
        (employee.role &&
          employee.role.name.toLowerCase() === selectedRole.toLowerCase());

      const matchesFTE =
        selectedFTE === 'All' ||
        (() => {
          if (employee.workLoad === undefined || employee.workLoad === null)
            return false;
  ...
  return (
    <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
      {/* Header */}
      <div className="mb-[11px] flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between pr-0 sm:pr-[24px]">
        <h1 className="font-['Poppins:Medium',_sans-serif] text-[24px] tracking-[-0.48px] text-[#19181d] leading-[32px] capitalize">
          Employees
        </h1>
        <button
          onClick={onAddEmployee}
          className="bg-[#7636ff] box-border content-stretch flex gap-[8px] h-[38px] items-center justify-center px-[24px] py-[12px] rounded-[8px] cursor-pointer hover:bg-[#6428e0] transition-colors w-full sm:w-auto"
        >
      ...
      {/* Filters Bar */}
      <div className="mb-[24px] flex flex-col gap-3 sm:flex-row sm:items-center">
        {/* Search */}
        <div className="bg-white border flex items-center gap-2 h-10 px-4 rounded-lg w-full sm:max-w-xs">
          <Search
            className="w-[16px] h-[14.476px] text-[#888796]"
            strokeWidth={2}
          />
          <input
            type="text"
        ...
        <div className="flex gap-2 flex-wrap sm:flex-nowrap sm:ml-auto">
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="flex gap-[8px] items-center">
                ...
                <ChevronDown
                  className="w-[16px] h-[16px] text-[#1f1e30]"
                  strokeWidth={2}
                />
              </div>
            </button>
            ...
            {isRoleOpen && (
              <div
                className="absolute top-[42px] left-0 bg-white border border-[#e6e6ec] rounded-[8px] shadow-lg z-10 min-w-[160px]"
          ...
          <div className="relative">
            ...
            {isFTEOpen && (
              <div
                className="absolute top-[42px] left-0 bg-white border border-[#e6e6ec] rounded-[8px] shadow-lg z-10 min-w-[120px]"
                onClick={(e) => e.stopPropagation()}
              >
                {fteOptions.map((fte) => (
                  <button
      ...
      <div className="overflow-x-auto -mx-4 sm:mx-0">
        <div className="bg-white rounded-[8px] border border-[#e6e6ec] min-w-[1145px]">
          {/* Table Header */}
          ...
          {isLoading ? (
            ...
            filteredEmployees.map((employee, index) => (
              <div
                key={employee.id}
                className="flex items-center h-[48px] border-b border-[#e6e6ec] last:border-b-0"
              >
                <div className="w-[48px] h-[48px] flex items-center justify-center p-[12px]">
                ...
                <div className="w-[138px] h-[48px] flex items-start px-[12px] py-[13px]">
                  <div
                    ...
                    style={{
                      backgroundColor:
                        employee.role?.backgroundColor ||
                        employee.roleBg ||
                        '#f3f4f6',
                      borderColor: `${
                        employee.role?.color || employee.roleColor || '#374151'
                      }4d`,
                    }}
                  >
                    <p
                ...
                <div className="w-[48px] h-[48px] flex items-center justify-center p-[12px] relative">
                  ...
                  {openMenuId === employee.id && (
                    ...
                    >
                      ...
                      >
                        <Edit2
                          className="w-[14px] h-[14px] text-[#7636ff]"
                          strokeWidth={2}
                        />
                        <span>Edit</span>
                      </button>
                      ...
                      >
                        <Trash2
                          className="w-[14px] h-[14px] text-[#d4183d]"
                          strokeWidth={2}
                        />
                        <span>Delete</span>
                      </button>
      ...
      {/* Employee Count */}
      <div className="mt-[24px] flex items-center justify-end w-full sm:max-w-[1145px] mx-auto">
        <p className="font-['Poppins:Medium',_sans-serif] text-[16px] tracking-[-0.32px] text-[#888796] leading-[16px]">
          <span>Showing </span>
