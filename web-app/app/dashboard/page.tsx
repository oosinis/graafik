...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto py-8">
      ...
      {/* Optional: Show error if roles failed to load */}
      {error && (
      ...
      {/* Your existing role check - works exactly the same! */}
      {hasRole('Manager') && (
      ...
      {/* Debug info - remove this once you confirm it's working */}
      <div className="bg-gray-100 p-3 rounded mb-4 text-sm">
        <strong>Debug:</strong> Roles loaded: {roles.join(', ') || 'No roles'}
      </div>
